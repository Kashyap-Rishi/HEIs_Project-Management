...
<h1> Leave a review</h1>
    ...
    <form className=""  onSubmit={handleSubmit} action="https://formspree.io/f/xyyqnqwy"
  method="POST">
...
<button type="submit" disabled={state.submitting} className="registerbtn">Send Message</button> 
